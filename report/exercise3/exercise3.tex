...
\begin{figure}[hb]
    ...
    \caption{The five-point stencil corresponding to central difference differentiation in both the $x$- and $y$-direction.} % TODO: Write.
\end{figure}
...
=======
>>>>>>> b93db62 (Slightly refines the stencil figures, and fixes captions and references to them.)
\begin{figure}[htb]
    \centering
    \input{./exercise3/flat_stencil.pgf}
    \label{ex3:fig:flat_stencil}
    \caption{By flattening the five-point stencil, we can write the system of equations, which is now on the form $AU = 0$.} % TODO: Write.
\end{figure}
