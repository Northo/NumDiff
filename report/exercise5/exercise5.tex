...
Now insert \ref{splitting_exact} into \cref{poisson_equation2}, multiply it by an arbitrary \textbf{trial function} $v(x)$ and integrate both sides from $a$ to $b$.
...
\begin{groupplot}[
	...
	\addplot [domain=0.1:4000, dashed, samples=2, black, forget plot] {0.19/x^2} node [pos=0.38,pin={0:$\Oh(h^2)$}] {};
	...
	\addplot [domain=0.1:4000, dashed, samples=2, black, forget plot] {22/x^2} node [pos=0.45,pin={0:$\Oh(h^2)$}] {};
	...
	\addplot [domain=0.1:4000, dashed, samples=2, black, forget plot] {122/x^2} node [pos=0.55,pin={0:$\Oh(h^2)$}] {};
	...
	\addplot [domain=0.1:4000, dashed, samples=2, black, forget plot] {0.10/x^1.15} node [pos=0.37,pin={30:$\Oh(h^{1.15})$}] {};
