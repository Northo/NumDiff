...
We now test our finite element method on four problems in \cref{femumr} with uniformly sized elements.
Except on the first problem, errors are distributed non-evenly across the elements.
