...
\figureseries{exercise5/data/UMR}{femumr}{
  Uniform mesh refinement on the one dimensional Poisson equation with inhomogenity $f$.
...
\figureseries{exercise5/data/AMR}{femamr}{
  Adaptive mesh refinement with the average strategy on the one dimensional Poisson equation with inhomogenity $f$.
...
\caption{\label{femconvergence}Convergence plots for the one dimensional Poisson equation, solved using the final element method.
  The inhomogenity $f$ used is indicated on each subplot.
  Uniform and two adaptive mesh refinemeth strategies are shown.
  See main text for details.}
\end{figure}
