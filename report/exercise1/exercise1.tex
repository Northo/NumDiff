...
\begin{figure}
	...
	\begin{tikzpicture}
		\begin{groupplot}[
			...
			\nextgroupplot[xmode=log,ymode=log,xlabel=$M$,ylabel={$\Ltwoerror{u-U}/\Ltwoerror{u}$},legend entries={$\Oh(h^2)$,$L_2$ (cont.),$L_2$ (disc.)},xmin=5,xmax=2000];
			\addplot [black, dashed, domain=1:3000, samples=2] {1.45/(x)^2};
...
\begin{loglogaxis}[
	...
	transpose legend, legend columns=2, legend entries={
		...
		{red!75!black,    solid, mark=square*, mark size=1.0pt},
		{red!100!black,   solid, mark=*,       mark size=1.0pt},
		{cyan!75!black,   solid, mark=square*, mark size=1.0pt},
		{cyan!100!black,  solid, mark=*,       mark size=1.0pt},
		{green!75!black,  solid, mark=square*, mark size=1.0pt},
		{green!100!black, solid, mark=*,       mark size=1.0pt},
		{yellow!60!black, solid, mark=square*, mark size=1.0pt},
		{yellow!80!black, solid, mark=*,       mark size=1.0pt},
	},
]
\addplot [black, dashed, domain=1:400, samples=2, forget plot] {1.8/x^2} node [pos=0.31,pin={-100:$\Oh(h^2)$}, inner sep=0pt] {};
