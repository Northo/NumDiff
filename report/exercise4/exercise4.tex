...
\begin{groupplot}[
	...
	\nextgroupplot[title={Crank-Nicholson}, xlabel=$t$,yticklabels={,,},cycle list={{red,line width=6pt},{blue,line width=4pt},{green,line width=2pt}}];
...
\end{groupplot}
\end{tikzpicture}
\caption{\label{norm_evolution}Norm evolution}
\end{figure}
...
\end{groupplot}
\end{tikzpicture}
\caption{\label{gaussian_evolution}Gaussian}
\end{figure}
