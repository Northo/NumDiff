...
\end{groupplot}
\end{tikzpicture}
\caption{\label{norm_evolution}Time evolution of the discrete $L_2$-norm of the initial gaussian $u(x,0) = \exp(x^2/0.1)$ computed from the Crank-Nicholson method and the Euler-method on different grids.}
\end{figure}
