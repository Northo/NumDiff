...
\begin{tikzpicture}
\begin{axis}[title={$N=10$},ylabel=$u$, xlabel=$x$, width=7.5cm]
...
\end{tikzpicture}
\begin{tikzpicture}
\begin{axis}[title={$N=100$},xlabel=$x$, width=7.5cm, colorbar, colorbar style={ylabel=$M$}]
...
\end{loglogaxis}
\end{tikzpicture}
\caption{Convergence plot at $t=1$, comparison between Crank-Nicholson and Forward Euler}
\end{figure}
