...
To find the expected convergence we start by finding the \textit{local truncation error}. 
...
and so we end up with the convergence orders of $\Oh(k+h^2)$ for Backwar Euler and $\Oh(k^2+h^2)$, 
as advertised. 
